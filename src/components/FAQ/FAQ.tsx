...
const FAQData = [
  ...
  },
  {
    ...
    answer:
      'To contact a seller on Abra Bulk Marketplace, click on the "Contact Seller" button on the product listing page. You will be redirected to a form where you can submit your inquiry. The seller will then respond to your message directly.',
  },
  {
    id: nanoid(),
