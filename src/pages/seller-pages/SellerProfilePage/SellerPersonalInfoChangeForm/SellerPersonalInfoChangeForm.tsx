...
export const SellerPersonalInfoChangeForm = (): JSX.Element => {
  ...
  //
  // const { countryShort, phoneNumberBody, lastName, firstName } = userPersonalInfo;
  //
  ...
  // ]);
  //
  // const serverPhoneNumber = `${numberCountry?.country_code}${phoneNumberBody}`;
  //
  ...
  //     phone_number: phoneNumberBody || phoneNumberBody,
