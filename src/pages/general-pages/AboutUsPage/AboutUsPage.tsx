      ...
      <div className={style.container}>
        ...
        <div className={style.container_text}>
          ...
          <p className={style.text}>
            ...
            to the best of Turkey&apos;s offerings, while ensuring a seamless and
          ...
          <p className={style.text}>
            <ul>
              <li>
                <b>1.</b>
                Wide Range of Products: We pride ourselves on offering an extensive
                product range, from textiles and apparel to food and beverages, home
                decor, and more. Our carefully curated selection ensures that you&apos;ll
              ...
              <li>
                ...
                meet our strict quality standards. Our team of experts handpicks each
                item, ensuring that only the finest products make their way to our
                customers.
              </li>
              ...
              <li>
                <b>4.</b> Reliable Shipping: We collaborate with renowned shipping
                partners to ensure timely and secure delivery of your orders, regardless
                of your location. Our streamlined logistics process guarantees that your
                products reach you safely and in perfect condition.
              </li>
          ...
          <p className={style.default_text}>
            At Abra Bulk Marketplace, we believe that every business deserves access to
