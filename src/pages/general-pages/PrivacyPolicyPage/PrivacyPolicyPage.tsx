    ...
    <div>
      ...
      <div className={style.container}>
        ...
        <Paragraph size="m" className={style.text}>
          ...
          account or contacting us at service@abra.com.
        </Paragraph>
        <Paragraph size="m" className={style.text}>
          b. Opt-out of marketing communications by clicking the &quot;unsubscribe&quot;
          link in any promotional email or contacting us at service@abra.com.
        </Paragraph>
        <Paragraph size="m" className={style.text}>
        ...
        <Paragraph size="m" className={style.text}>
          ...
          contact us at service@abra.com, and we will take steps to remove such
        ...
        <Paragraph size="m" className={style.text}>
          ...
          us at service@abra.com. Please note that we may need to verify your identity
