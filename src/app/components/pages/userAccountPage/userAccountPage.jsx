    ...
    return (
        <div className={style.userCabinet}>
            <div className={style.userCabinet__contentWrapper}>
                ...
                <div className={`${style.section} ${style.orders}`}>
                    <div className={style.header__wrapper}>
                        ...
                        <Link className={style.header__link} to="/">View All</Link>
                    </div>
                    <div className={style.ordersCategory__wrapper}>
                        <ButtonLink name="Unpaid" src={iconImage} classes ={ordersCategoryBtnClasses} href="*"/>
                        <ButtonLink name="To be shipped" src={iconImage} classes ={ordersCategoryBtnClasses} href="*"/>
                        <ButtonLink name="Shipped" src={iconImage} classes ={ordersCategoryBtnClasses} href="*"/>
                        <ButtonLink name="To be reviewed" src={iconImage} classes ={ordersCategoryBtnClasses} href="*"/>
                        <ButtonLink name="Completed" src={iconImage} classes ={ordersCategoryBtnClasses} href="*"/>
                    </div>
                </div>
                ...
                <div className={`${style.section} ${style.myAddresses}`}>
                    <div className={style.header__wrapper}>
                        ...
                        <Link className={style.header__link} to="/">Add new</Link>
                    </div>
                    <div className={style.myAddresses__wrapper}>
                        <p className={style.noAddress}>You have not added any address yet.</p>
                        <p className={style.noAddress}>Once you place your first order, you will be able to save your address.</p>
                    </div>
                </div>
            ...
            <div className={style.removeWrapper}>
                ...
                <div className={style.linkDescription}>(All your data including order history will be deleted)</div>
            </div>
        </div>
