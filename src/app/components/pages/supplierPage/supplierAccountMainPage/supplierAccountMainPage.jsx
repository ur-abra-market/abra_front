        ...
        <div className={`${style.section} ${style.businessProfile}`}>
          ...
          <div className={style.profileLogo}>
            <div className={style.profileLogo_backgroung}>
              <img className={style.profileLogo_img} src={iconImage} alt="logo"/>
            </div>
            <div className={style.profileLogo_description}>
              <div className={style.profileLogo_descriptionTitle}>Add logo or profile image</div>
              <div className={style.profileLogo_descriptionSubtitle}>The customers will recognizeyour</div>
              <div className={style.profileLogo_descriptionSubtitle}>store by this image</div>
            </div>
          </div>
          <div className={style.fieldsWrapper}>
            <div className={style.flexContainer}>
        ...
        <div className={`${style.section} ${style.notifications}`}>
          ...
          <div className={style.notificationsList}>
            <div className={style.notificationsList__item}>
              <Checkbox label="Discounts & offers" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="Order updates" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="Order reminders" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="On stock again" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="Product is cheaper" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="Your favorites new" classes={notificationCheckboxClasses} />
            </div>
            <div className={style.notificationsList__item}>
              <Checkbox label="Account support" classes={notificationCheckboxClasses} />
            </div>
          </div>
        </div>
