...
import { firstname, lastname, street, apartment, city, region, state, zipcode } from '../../../store/reducers/modalSlice';
...
const TextModal = ({title, placeholder}) => { 
  ...
  return (
    <div className='TextModal'>
      ...
      <input className='TextModal-input' type="text" placeholder={placeholder} value={input} onChange={(e) => handlerText(e.target.value)}/>
    </div>
  )
}
