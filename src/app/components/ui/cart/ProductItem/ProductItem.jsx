    ...
    return (
        <div className={style.productItem}>
            <div className={style.productItem__mainContainer}>
                <div>
                    <input className={style.productItem__mainContainer_checkbox}
                ...
                <div>
                    ...
                    <div className={style.productItem__mainContainer_price}>
                        <p>${product.price}</p>
                        <p className={style.productItem__mainContainer_priceSpecial}>Special
                            offer: ≥ 200 = 1pc/$4.25
                        </p>
                    </div>
                </div>
            ...
            <div className={style.productItem__quantityContainer}>
                ...
                <div className={style.productItem__quantityContainer_quantity}>
                    <button className={style.productItem__quantityContainer_button}>
                        -
                    </button>
                    <input className={style.productItem__quantityContainer_input}
