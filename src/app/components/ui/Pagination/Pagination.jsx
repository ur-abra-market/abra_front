  ...
  return (
    <div className={styles.Paginator}>
      ...
      <div className={styles.Paginator__numbers}>
        <div
          className={
            activePage === 1 ? `${styles.activePage}` : `${styles.cursor}`
          }
        ...
        <div
          className={
            amountPages < 5 || activePage < 5 ? `${styles.invisible}` : ''
          }
        >
          ...
        </div>
        ...
        <div
          className={
            amountPages < 5 || amountPages - activePage < 4
              ? `${styles.invisible}`
              : ''
          }
        >
      ...
      <div
        ...
        onClick={() =>
          activePage < amountPages ? handlePage(activePage + 1) : false
        }
      >
