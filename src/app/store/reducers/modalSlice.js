...
export const { address, payment, main, firstname, lastname, phone, street, building, apartment, city, region, state, country, zipcode, addAddress, addressNull } = modalSlice.actions;
